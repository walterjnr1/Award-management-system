...
<title>Vote Here| <?php echo $sitename; ?></title>
...
<script type="text/javascript">
		function validate_vote(candName){
if(confirm("ARE YOU SURE YOU WISH TO VOTE FOR" + " " + candName+ " " + " ?"))
{
return  true;
}
else {return false;
          ...
          <div class="col-xl-12" >
            <div class="info-box">
              <div class="card-header">
                <h2 align="center" class="card-title style2">Choose your Candidate Here</h2>
              </div>
                  ...
                  <table width="103%" height="87" align="right" class="table table-hover">
                    <thead class="bg-primary text-white">
                      <tr>
                        ...
                        <th width="17%"><div align="center">Department</div></th>
                        <th width="29%"><div align="center">Category</div></th>
                        <th width="29%"><div align="center">Votes</div></th>
                        <th width="22%"><div align="center">Action</div></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php 
$data = $dbh->query("SELECT * FROM candidate where category='$type_id' ORDER BY candName ASC")->fetchAll();
$cnt=1;
foreach ($data as $row) {
?>
                      <tr>
                        ...
                        <div><td><a class="btn btn-sm btn-outline-primary" href="vote_exec.php?uid=<?php echo $row['userid'];?>&cat=<?php echo $row['category'];?>"onClick="return validate_vote('<?php echo $row['candName']; ?>');">Vote here ..</a></div><td width="0%"></td>
                      </tr>
                      <?php $cnt=$cnt+1;} ?>
                    </tbody>
                  </table>
          ...
          <p align="center"><a href="vote_step_1.php"><strong>&lt;&lt; Return</strong></a></p>
        </div>
        <div align="center">
