...
$sql = "UPDATE tblclient SET photo=? where email=?";
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="user-profile-box m-b-3">
            <div class="box-profile text-white"> <img class="profile-user-img img-responsive img-circle m-b-2" src="../Admin/<?php echo $row_client['photo']; ?>" alt="client profile picture">
              <h3 class="profile-username text-center style1"><?php echo $row_client['firstname']; ?> <?php echo $row_client['lastname']; ?></h3>
 ...
 <?php } ?></p>
             ...
             <form  action="" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-10">
                                    <div align="center"><img src="../Admin/<?php echo $row_client['photo'];   ?>" alt="client photo" width="178" height="154" id="logo-img">   
                          </div>
                        </div>
                      </div>
