...
$sql = "UPDATE tblregister SET fullname=?, email=?,sex=?,dob=?,user_type=?,dept=? where userid=?";
$stmt= $dbh->prepare($sql);
$stmt->execute([$fullname,$email,$sex,$dob,$type,$dept,$userid]);
if($stmt) {
      ...
      <div class="row">
        <div class="col-lg-9">
         ...
         <label for="exampleInputEmail1">Fullname</label>
			<input type="text" class="form-control" id="txtfullname" name="txtfullname" value="<?php echo $row_user['fullname']; ?>" >
        </div>
			  <div class="form-group">
                <label for="exampleInputEmail1">Sex</label>
                <select name="cmdsex" class="f1-last-name form-control" id="cmdsex"> 
                <option value="<?php echo $row_user['sex']; ?>"><?php echo $row_user['sex']; ?></option>
			   ...
			   <div class="form-group">
                ...
                <input type="date" class="form-control" id="txtdob" name="txtdob" value="<?php echo $row_user['dob']; ?>">
              </div>
              <div class="form-group">
         <label for="exampleInputEmail1">Email</label>
			<input type="text" class="form-control" id="txtemail" name="txtemail" value="<?php echo $row_user['email']; ?>" >
        </div>
              <div class="form-group">
                <label for="exampleInputEmail1">User Type</label>
                <select name="cmdtype" class="f1-last-name form-control" id="cmdtype"> 
                ...
                <select name="cmddept" class="f1-last-name form-control" id="cmddept"> 
                <option value="<?php echo $row_user['dept']; ?>"><?php echo $row_user['dept']; ?></option>
