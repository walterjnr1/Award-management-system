...
if(empty($_SESSION['login_userid']))
  ...
  $sql = "select * from tblregister where userid = '$userid'";
  $statement = $dbh->query($sql);
  $rowuserid = $statement->fetchAll(PDO::FETCH_ASSOC);
...
<?php $error='NEW Password and CONFIRM password not Matched';?>
  <?php } else {
 $sql = "UPDATE tblregister SET password=? where userid=?";
$stmt= $dbh->prepare($sql);
$stmt->execute([$confirm_new, $userid]);
if($stmt) {
...
$success='Password changed Successfully...';
  ...
  $error='Problem Editing Password ';
}
}
}
...
<div class="wrapper boxed-wrapper">
 ...
 <?php } ?>
			...
			<input type="text" class="form-control" id="refplotno" name="txtold_password" value="<?php if (isset($_POST['txtold_password']))?><?php echo $_POST['txtold_password']; ?>" type="text"  required>
