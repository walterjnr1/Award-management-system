...
$stmt = $dbh->prepare("SELECT * FROM candidate WHERE userid=?");
$stmt->execute([$userid]);
$user = $stmt->fetch();

if ($user) {
$_SESSION['error'] ='User ID Already Exist in our Database ';

} else {
 //Add User details
$sql = 'INSERT INTO candidate(candName,userid,phone,dept,category,photo,count) VALUES(:candName,:userid,:phone,:dept,:category,:photo,:count)';
$statement = $dbh->prepare($sql);
$statement->execute([
	':candName' => $_POST['txtfullname'],
...
<head>
  ...
  <title>Nominate Candidate - <?php echo $sitename; ?></title>
        ...
        <div class="row">
		 ...
		 <!-- general form elements -->
              ...
              <form  action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="txtuserid" id="exampleInputPassword1" size="77" value="<?php if (isset($_POST['txtuserid']))?><?php echo $_POST['txtuserid']; ?>" placeholder="Enter Lecturer ID">
                  </div>
           ...
           <div class="form-group">
                    ...
                    <p class="text-center">
                   <img src="../uploadImage/default.jpg" alt="user image" width="178" height="154" id="logo-img">
				    </p>
              </div>
