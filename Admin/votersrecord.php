...
<head>
  ...
  <title>Voter's Record|<?php echo $sitename ; ?></title>
                  ...
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr> <th width="3%"><div align="center">#</div></th>
                        <th width="5%"><div align="center">Photo</div></th>
		            	<th width="15%"><div align="center">FullName</div></th>
                        <th width="8%"><div align="center">User ID</div></th>
                        <th width="7%"><div align="center">Password</div></th>
						            <th width="8%"><div align="center">Email</div></th>
                        <th width="7%"><div align="center">Sex</div></th>
                        <th width="8%"><div align="center">Date of Birth</div></th>
                        <th width="7%"><div align="center">User Type</div></th>
		                <th width="9%"><div align="center">Department</div></th>
                        <th width="8%"><div align="center">Date of registration</div></th>
                    ...
                    <tbody>
                							            <?php
                                          $sql = "SELECT * FROM tblregister ORDER BY date_reg DESC";
                                           $result = $conn->query($sql);
									                      	$cnt=1;
                                           while($row = $result->fetch_assoc()) {
										                     ?>
                                <tr class="gradeX">
				                  <td height="68"><div align="center"><?php echo $cnt; ?></div></td>
                          ...
                          <td><div align="center"><?php echo $row['user_type']; ?></div></td>
                          <td><div align="center"><?php echo $row['dept']; ?></div></td>
                          <td><div align="center"><?php echo $row['date_reg']; ?></div></td>
                          <td>
                        ...
                        { ?>
                           ...
                           <div align="center">
                            ...
                            <?php } ?>
                            <a href="delete-users.php?uid=<?php echo $row['userid'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');">Delete </a></div>
                            </td>
                      </tr>
                      <?php $cnt=$cnt+1;} ?>
                    </tbody>
