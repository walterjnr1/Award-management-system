...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if ($result)
    {
        ...
        $row_no_voters = mysqli_num_rows($result);
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h6><strong><?php echo $row_no_voters;?></strong></h6>
...
{
    // it return number of rows in the table.
    $row_no_category = mysqli_num_rows($result);
}
?>
      <div class="col-lg-3 col-6">
        <!-- small box -->
        <div class="small-box bg-primary">
          <div class="inner">
            <h6><?php echo $row_no_category; ?></h6>

            <p><strong>No. of Category </strong></p>
          </div>
          <div class="icon">
            <i class=""></i>
          </div>
      ...
      <!-- ./col -->
      <table width="899" height="148" border="0" align="center">
        <tr>
          <td width="629"><div class="card">
            <div class="card-header">
              <h3 class="card-title">Voting result</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table class="table table-bordered">
                ...
                <tbody>
                <?php
                        $sql = "SELECT * FROM candidate ORDER BY category DESC";
