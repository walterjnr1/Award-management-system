...
<head>
  ...
  <title>Candidate Record|<?php echo $sitename; ?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Candidate Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <table width="1161" border="0" align="center">
            <tr>
              <td width="1155"><div class="card">
                ...
                <a class="btn btn-primary" href="add-candidate.php">Add Candidate</a>
                  ...
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                      ...
                      <th width="13%"><div align="center">Photo</div></th>
                        <th width="13%"><div align="center">User ID</div></th>
