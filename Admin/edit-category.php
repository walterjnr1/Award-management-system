...
$stmt = $dbh->prepare("SELECT * FROM tblcategory WHERE name=?");
...
$_SESSION['error'] ='category Already Exist in our Database ';
 ...
 //edit User details
 $sql = "UPDATE tblcategory SET name=?,description=? where ID =?";
 $stmt= $dbh->prepare($sql);
 $stmt->execute([$category,$description,$id]);

if($stmt) {
header( "refresh:2;url= edit-category.php" );
$_SESSION['success'] ='category Editing Successfully';
}else{
$_SESSION['error'] ='Problem Editing category';
}
}
}
...
<head>
  ...
  <title>Edit Category - <?php echo $sitename; ?></title>
...
if(confirm("ARE YOU SURE YOU WISH TO DELETE CATEGORY ?"))
{
return  true;
}
else {return false;
            ...
            <div class="card card-primary">
              ...
              <form  action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtcategory" id="exampleInputEmail1" size="77" value="<?php echo $row_category['name'];    ?>" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Category Name </label>
                    <textarea name="txtdescription" cols="1000" class="form-control" id="exampleInputEmail1"><?php echo $row_category['description'];    ?></textarea>
                  </div>
                  	   </div>
                <!-- /.card-body -->
              ...
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tr> <th width="3%"><div align="center">#</div></th>
                        ...
                        <th width="13%"><div align="center">Description</div></th>
...
<?php
                  $data = $dbh->query("SELECT * FROM tblcategory ORDER BY name DESC")->fetchAll();
                  $cnt=1;
                  foreach ($data as $row) {
                    ?>
