...
$_SESSION['error'] ='category Already Exist in our Database ';
 ...
 //Add User details
$sql = 'INSERT INTO tblcategory(name,description) VALUES(:name,:description)';
            ...
            <div class="card card-primary">
              ...
              <form  action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtcategory" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtcategory']))?><?php echo $_POST['txtcategory']; ?>" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Category Name </label>
                    <textarea name="txtdescription" cols="1000" class="form-control" id="exampleInputEmail1"><?php if (isset($_POST['txtdescription']))?><?php echo $_POST['txtdescription']; ?></textarea>
                  </div>
                  	   </div>
                <!-- /.card-body -->
